      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="mb-10 max-w-3xl">
          ...
          <p className="mt-5 text-lg font-medium leading-8 text-cyan-300 drop-shadow-[0_0_8px_rgba(34,211,238,0.18)]">
            Los lugares de honor se llenarán con datos reales de participación,
            votos, vistas y evaluación. Mientras no haya resultados oficiales,
            el salón permanece en modo estreno.
          </p>
        </div>
        ...
        <div className="rounded-[32px] border border-white/[0.16] bg-white/[0.035] p-6 shadow-[0_0_18px_rgba(250,204,21,0.11),inset_0_1px_0_rgba(255,255,255,0.18)] md:p-8">
          <div className="grid gap-4 md:grid-cols-4">
            {[
              ["VOZ", "Top 10", "Se activará cuando existan votos oficiales."],
              ["REG", "Regional", "Ranking por ciudad, país o comunidad."],
              ["CAT", "Categoría", "Canto, danza, actuación, comedia e instrumentos."],
              ["ET", "Proyecto Estrella", "Selección editorial con resultados reales."],
            ].map(([icon, title, text]) => (
              <article
                key={title}
              ...
              >
                <div className="mb-5 flex h-16 w-16 items-center justify-center rounded-2xl border border-white/20 bg-[linear-gradient(180deg,rgba(255,255,255,0.24),transparent_46%),linear-gradient(90deg,rgba(34,211,238,0.72),rgba(236,72,153,0.66),rgba(250,204,21,0.72))] text-sm font-black tracking-[0.14em] shadow-[0_0_18px_rgba(34,211,238,0.18),inset_0_1px_0_rgba(255,255,255,0.26)]">
                  {icon}
                </div>
